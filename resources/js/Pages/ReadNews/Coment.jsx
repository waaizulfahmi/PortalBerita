const Coment = () => {
                ...
                <div className="box-border flex flex-wrap ">
                    <div className="box-border md:w-2/3 box-content">
                        <div className="box-content h-22 w-30 p-4 border-2 bg-violet-200">
                            <p className="font-bold text-2xl mb-3">Komentar</p>
                            <div>
                            <input type="text" placeholder="Tuliskan Komentar Anda" className="input input-bordered h-16 w-50 w-full mb-2" />
                            </div>
                            <div>
                            <input type="text" placeholder="Nama" className="input input-bordered h-8 w-50 w-full mb-2" />
                            <input type="text" placeholder="Email" className="input input-bordered h-8 w-50 w-full mb-2" />
                            </div>
                            <div dir="rtl">
                            <button className="btn btn-active btn-ghost btn-sm">Kirim Komentar</button>
                            </div>
                        </div>
                        <div className="box-content h-22 w-30 p-4 border-2 bg-violet-200">
  ...
  <div class="text-center space-y-2 sm:text-left">
    <div class="space-y-0.5">
      ...
      <time className="time text-sm">12 April 2023</time>
      <p class="text-slate-500 font-medium">
      Lorem ipsum dolor, sit amet consectetur adipisicing
                            elit.
      </p>
    </div>
    <button class="px-4 py-1 text-sm text-purple-600 font-semibold rounded-full border border-purple-200 hover:text-white hover:bg-purple-600 hover:border-transparent focus:outline-none focus:ring-2 focus:ring-purple-600 focus:ring-offset-2">Balas</button>
  </div>
</div>
...
<div class="text-center space-y-2 sm:text-left">
    <div class="space-y-0.5">
      ...
      <time className="time text-sm">12 April 2024</time>
      <p class="text-slate-500 font-medium">
      Lorem ipsum dolor, sit amet consectetur adipisicing
                            elit.
      </p>
...
<div class="text-center space-y-2 sm:text-left">
    <div class="space-y-0.5">
      ...
      <time className="time text-sm">27 April 2024</time>
      <p class="text-slate-500 font-medium">
      Lorem ipsum dolor, sit amet consectetur adipisicing
                            elit.
      </p>
...
<div class="py-8 px-8 bg-white rounded-xl shadow-lg space-y-8 sm:py-4 sm:flex sm:space-y-0 sm:space-x-6 mb-2">
  <div class="text-center space-y-2 sm:text-left">
    <div class="space-y-0.5">
      ...
      <time className="time text-sm">22 April 2024</time>
      <p class="text-slate-500 font-medium">
      Lorem ipsum dolor, sit amet consectetur adipisicing
                            elit.
      </p>
    ...
    <button class="px-4 py-1 text-sm text-purple-600 font-semibold rounded-full border border-purple-200 hover:text-white hover:bg-purple-600 hover:border-transparent focus:outline-none focus:ring-2 focus:ring-purple-600 focus:ring-offset-2">Balas</button>
                    ...
                    <div className="p-2 ml-10">
                            <a href=""><h1 className="text-black p-3 lg:text-2xl sm:text-xl font-bold text-center mb-3">
                                Ikuti Kami
                            </h1></a>
                            ...
                            <div className=" mx-auto mt-4">
                                <section className="mb-30 text-gray-800 text-center md:text-left">
                                    ...
                                    <hr />
                                    <u>
                            <a href=""><h1 className="text-black p-3 lg:text-2xl sm:text-xl font-bold mb-4">
                                Berita Terpopuler
                            </h1></a>
                            </u>
                                ...
                                <div>
                                    <div className="text-lg font-bold text-black mb-2">Nasdem Akan Beri Kejutan Soal Cawapres Anies</div>
