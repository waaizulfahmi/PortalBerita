        ...
        let data = sortedData.map(([key, val] = entry) => {
            return (
                <li className="px-1 py-4 border-b border-t border-white hover:border-gray-200 transition duration-300">
                    <Link
                        href={`/category/${key}`}
                        className="flex items-center text-gray-600 cursor-pointer  hover:text-yellow-400  duration-100"
                    >
            ...
            <div className="mt-0 p-4 bg-violet-200 xl:ml-16 xl:mr-0 xl:mt-2 lg:mb-2 lg:ml-14 ml-1 mr-1 mb-2 rounded-sm sm:mb-2 sm:ml-2 sm:mr-2 md:ml-4 md:mr-4">
                ...
                <div className="flex flex-wrap mb-3 ml-2 lg:ml-0 md:ml-0 sm:ml-0 space-x-2">
                    <div className="flex ">
                        <div className="shrink-0 ml-3">
                            <Link as="button">
                                <h1 className="font-bold text-5xl pr-1 ml-1">
                                    1
                                </h1>
                            </Link>
                        </div>
                        <div className="px-7 text-left">
                            <Link href={route("read", props.trends[0].slug)}>
                                <h5 className="text-sm md:text-base lg:text-base font-bold text-left hover:text-yellow-400  duration-100">
                                    {props.trends[0].title}
                                </h5>
                                <h5 className="text-xs ">
                                    {props.trends[0].category} |{" "}
                                    {formatDate(props.trends[0].created_at)}
                                </h5>
                            </Link>
                        </div>
                    </div>
                ...
                <div className="flex flex-wrap mb-3 ml-2 lg:ml-0 md:ml-0 sm:ml-0 space-x-2">
                    <div className="flex ">
                        ...
                        <div className="px-7 text-left">
                            <Link href={route("read", props.trends[1].slug)}>
                                <h5 className="text-sm md:text-base lg:text-base font-bold text-left  hover:text-yellow-400  duration-100">
                                    {props.trends[1].title}
                                </h5>
                                <h5 className="text-xs">
                                    {" "}
                                    {props.trends[1].category} |{" "}
                                    {formatDate(props.trends[1].created_at)}
                                </h5>
                            </Link>
                        </div>
                    </div>
                ...
                <div className="flex flex-wrap mb-1 ml-2 lg:ml-0 md:ml-0 sm:ml-0 space-x-2">
                    <div className="flex ">
                        ...
                        <div className="px-7 text-left">
                            <Link href={route("read", props.trends[2].slug)}>
                                <h5 className="text-sm md:text-base lg:text-base font-bold text-left mb-2  hover:text-yellow-400  duration-100">
                                    {props.trends[2].title}
                                </h5>
                                <h5 className="text-xs">
                                    {" "}
                                    {props.trends[2].category} |{" "}
                                    {formatDate(props.trends[2].created_at)}
                                </h5>
                            </Link>
                        </div>
                    </div>
