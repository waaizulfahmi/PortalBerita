...
<<<<<<< HEAD
                        <h5 className="text-gray-500 mb-6">Nasional</h5>
...
>>>>>>> 1d6993b197d20f6fc6dffdb1ba3a7c17474dfbee
                        ...
                        <div className="flex justify-end space-x-2">
                            ...
                            <div>
<<<<<<< HEAD
                                <button className="btn btn-active btn-ghost btn-sm mb-2">
=======
...
<<<<<<< HEAD
                        <div class="box-border h-80 w-50 border-0 mb-10"></div>
                        <div>
                            <div className="text-gray-500 mb-6 flex justify-start">
                                <div>
                                    <p class="font-bold text-bold text-2xl transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300">
=======
                        ...
                        <p className="text-lg ml-3 mb-14 mr-3">
                            ...
                            mengatakan para pemain bertahannya tampil cukup
                            bagus saat menghadapi tuan rumah Uzbekistan pada
                            pertandingan terakhir Grup A Piala Asia U-20 yang
                            dimainkan di Stadion Istiqlol, Fergana, Selasa malam
                            waktu setempat. Uzbekistan sempat beberapa kali
                            menciptakan peluang bagus untuk membobol gawang
                            Indonesia yang dijaga kiper Daffa Fasya. Namun,
                            berkali-kali pula para pemain bertahan Indonesia
                            yang dikomandoi Muhammad Ferrari mampu menggagalkan
                            serangan-serangan itu, sehingga pertandingan
                            tersebut berakhir imbang 0-0. "Saya rasa perihal
                            pertahanan, kami tampil baik karena hingga akhir
                            pertandingan tidak kemasukan gol. Jadi para pemain
                            juga layak mendapatkan pujian. Untuk memenangkan
                            pertandingan, seluruh tim harus menjadi satu selama
                            90 menit," kata Shin Tae-yong pada konferensi pers
                            setelah pertandingan Hasil imbang melawan Uzbekistan
                            belum cukup untuk membawa Indonesia lolos ke
                            perempat final Piala Asia U-20. Timnas U-20 hanya
                            menduduki posisi ketiga klasemen akhir Grup A dengan
                            empat poin. Koleksi poin itu sebenarnya sama dengan
                            Irak yang pada pertandingan terakhir bermain imbang
                            1-1 dengan Suriah, namun Irak unggul selisih gol.
                            Meski demikian, pelatih Shin meyakini para pemain
                            dapat memetik pelajaran, terutama dari pertandingan
                            melawan Uzbekistan, terkait keterbatasan para pemain
                            saat bertemu tim-tim dari negara yang lebih besar
                            "Seperti yang anda lihat, para pemain Uzbekistan
                            secara fisik lebih besar dari para pemain kami, dan
                            kondisi ini cukup menyulitkan para pemain kami. Jadi
                            kondisi fisik adalah kekuarangan kami. Karenanya
                            mulai sekarang mereka harus bekerja ekstra untuk
                            meningkatan kekuatan fisik mereka," kata pria asal
                            Korea Selatan itu. Setelah perjuangan di level Asia,
                            timnas U-20 akan kembali mengikuti turnamen penting
                            yakni Piala Dunia U-20 Mei mendatang. Untuk
                            kompetisi tersebut, pelatih Shin mengatakan dirinya
                            akan melakukan beberapa perubahan di dalam skuad.
                        </p>
                        <div>
                            <div className="text-gray-500 mb-6 flex justify-start">
                                <div>
...
>>>>>>> 1d6993b197d20f6fc6dffdb1ba3a7c17474dfbee
                                ...
                                <div>
<<<<<<< HEAD
                                    <button className="btn btn-active btn-ghost btn-sm ml-6 mb-2 transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300">
=======
