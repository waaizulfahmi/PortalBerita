            ...
            <main className="max-w-7xl mx-auto ">
                <div className="box-border flex flex-wrap">
                    <article className="w-full h-full md:w-3/5  p-4">
                        <u>
                            <h1 className="text-black p-2 mb-2 lg:text-2xl sm:text-xl font-bold">
                                Berita Terkini
                            </h1>
                        </u>
                                            ...
                                            <div className="relative  overflow-hidden bg-no-repeat bg-cover ripple shadow-lg rounded-lg mb-2">
                                                ...
                                                />
                                                    <div className="absolute top-0 right-0 bottom-0 left-0 w-full h-full overflow-hidden bg-fixed">
                                                        <div className="flex justify-start items-end h-full">
                                                            <div className="text-white m-3">
                                                                <Link href={route('readnews')} as="button"><h4 className="text-left text-base text-white font-bold ">
