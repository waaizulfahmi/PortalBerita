            ...
            <main className="max-w-8xl mx-auto ">
                <div className="box-border flex flex-wrap">
                    <div className="row-span-3  container my-5  mx-auto md:w-2/3">
                        <u>
                            <a href="">
                                <h1 className="text-black p-4 lg:text-2xl  sm:text-xl ml-28 font-bold">
                                    Berita Terbaru
                                </h1>
                            </a>
                        </u>
                            ...
                            <div className="flex flex-wrap mb-1/2">
                                ...
                                <div className="grow-0 shrink-0 basis-auto w-full md:w-9/12 xl:w-7/12 px-3 mb-6 md:mb-0 mr-auto">
                                    ...
                                    <small className="text-gray-500">
                                        ...
                                        adipisicing elit. Quos quod iusto eum
                                        quae eos commodi aperiam odio omnis esse
                                        pariatur, rerum, velit fugit nesciunt?
                                    </small>
                                </div>
                            </div>
                                    ...
                                    <div className="flex flex-wrap mb-1">
                                        ...
                                        <div className="grow-0 shrink-0 basis-auto w-full md:w-9/12 xl:w-7/12 px-3 mb-6 md:mb-0 mr-auto">
                                            <Link
                                                ...
                                                as="button"
                                            >
                                                <h5 className="text-lg text-left font-bold mb-3">
                                                    Awali Harimu dengan Semangat
                                                </h5>
                                            </Link>
                                            <div className="mb-1 text-red-600 font-medium text-sm flex items-center justify-center md:justify-start">
