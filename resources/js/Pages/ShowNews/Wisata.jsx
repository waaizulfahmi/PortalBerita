...
const Wisata = () => {
    return (
        ...
        <div className="row-span-3  container my-5  mx-auto md:w-2/3">
        <u>
                            <a href=""><h1 className="text-black p-4 lg:text-2xl  sm:text-xl ml-28 font-bold">
                                Berita Terbaru
                            </h1></a>
                            </u>
            <section className="mb-36 text-gray-800 text-center md:text-left">
                {/* <h1>Berita Hot</h1> */}
                <div className="flex flex-wrap mb-1/2">
                    <div className="grow-0 shrink-0 basis-auto w-full md:w-2/12 px-0 mb-6 md:mb-0 ml-auto">
                        <div className="relative  overflow-hidden bg-no-repeat bg-cover ripple shadow-lg rounded-lg mb-10 transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300">
                            <img
                                className="w-full"
                    ...
                    <div className="grow-0 shrink-0 basis-auto w-full md:w-9/12 xl:w-7/12 px-3 mb-6 md:mb-0 mr-auto">
                        <Link href={route('readnews')} as="button"><h5 className="text-lg font-bold mb-3">Hello World</h5></Link>
                        ...
                        <small className="text-gray-500">
                            ...
                            elit. Quos quod iusto eum quae eos commodi aperiam
                            odio omnis esse pariatur, rerum, velit fugit
                            nesciunt?
                        </small>
                    </div>
                </div>
                            ...
                            <div className=" mx-auto mt-2">
                                <section className="mb-30 text-gray-800 text-center md:text-left">
                                    ...
                                    <div className="flex flex-wrap mb-1">
                                        ...
                                        <div className="grow-0 shrink-0 basis-auto w-full md:w-9/12 xl:w-7/12 px-3 mb-6 md:mb-0 mr-auto">
                                            <Link href={route('readnews')} as="button"><h5 className="text-lg text-left font-bold mb-3">
                                                Awali Harimu dengan Semangat
                                            </h5></Link>
                                            <div className="mb-1 text-red-600 font-medium text-sm flex items-center justify-center md:justify-start">
                                                <svg
