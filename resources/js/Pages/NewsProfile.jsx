const NewsProfile = () => {
    return (
        <div className="grid grid-rows-3 grid-flow-col gap-1 ml-10">
            <div className="flex flex-wrap mb-1">
                <div className="grow-0 shrink-0 basis-auto w-full md:w-3/12 px-5 mb-6 md:mb-0 ml-auto">
                ...
                <div className="grow-0 shrink-0 basis-auto w-full md:w-9/12 xl:w-7/12 px-3 mb-6 md:mb-0 mr-auto">
                    <h5 className="text-lg font-bold mb-3">Hidup Sederhana</h5>
