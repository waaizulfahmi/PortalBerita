    ...
    return news.map((data, i) => {
        ...
        return (
            ...
            <div className="container mx-auto">
                <u>
                <h1 className="text-3xl font-semibold text-gray-800 capitalize lg:text-4xl dark:text-white">Berita Olahraga</h1>
                </u>
                <div className="grid grid-cols-1 gap-8 mt-8 md:mt-8 md:grid-cols-2">
                    <div className="lg:flex">
                        ...
                        <div className="flex flex-col justify-between py-6 lg:mx-6">
                            ...
                            <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Corporis hic odio expedita quis, labore quisquam.</p>
