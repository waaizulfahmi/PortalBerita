...
const ListNewsRow = () => { 
    return (     
        <div className="container my-5  mx-auto ml-0">
            <section className="mb-15 text-gray-800 text-center md:text-left">
                ...
                <div className="flex flex-wrap mb-1/2">
                    ...
                    <Link href={route('readnews')} as="button"><div className="relative  overflow-hidden bg-no-repeat bg-cover ripple shadow-lg rounded-lg mb-6 transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300">
                            <img
                                className="w-full"
                    ...
                    <div className="grow-0 shrink-0 basis-auto w-full md:w-9/12 xl:w-7/12 px-3 mb-6 md:mb-0 mr-auto">
                        ...
                        <p className="text-gray-500">
                            ...
                            nesciunt? Repellat. Lorem ipsum dolor sit amet
                            consectetur adipisicing elit. Esse voluptatum
                            recusandae fugit!
                        </p>
                    </div>
                </div>
                ...
                <div className="flex flex-wrap mb-1">
                    ...
                    <div className="grow-0 shrink-0 basis-auto w-full md:w-9/12 xl:w-7/12 px-3 mb-6 md:mb-0 mr-auto">
                    <Link href={route('readnews')} as="button"><h5 className="text-lg font-bold mb-3">Awali Harimu Dengan Semangat</h5></Link>
                        <div className="mb-3 text-red-600 font-medium text-sm flex items-center justify-center md:justify-start">
                            <svg
                                className="w-4 h-4 mr-2"
                                xmlns="http://www.w3.org/2000/svg"
        ...
        //     adipisicing elit. Fugiat, officiis
        //     laudantium?
        // </p>
        //                     </div>
        //                 </div>
