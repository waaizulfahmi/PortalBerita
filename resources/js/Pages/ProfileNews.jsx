    ...
    return ( 
        <div>   
            <main className="max-w-7xl mx-auto "> 
                <div className="box-border flex flex-wrap mb-12">
            ...
            <div className="card w-full  lg:w-56">
             <Link href={route('readnews')} as="button"><img className="mb-3 transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300" src="https://www.pinhome.id/info-area/wp-content/uploads/2022/02/Ambalika-Kuliner-Kota.jpg" alt="Shoes" /></Link>
                ...
                <div className="mb-0 text-red-600 font-medium text-sm flex items-center justify-center md:justify-start">
                    ...
                    <aside className="w-full md:w-1/3 ml-14 ">  
                            ...
                            <div className="mx-auto">
                                ...
                                <Link href={route('readnews')} as="button"><div className="text-lg text-left font-bold text-black mb-2">Nasdem Akan Beri Kejutan Soal Cawapres Anies</div></Link>
                                    ...
                                    {/* <div className="flex flex-wrap mb-1 ">
                                        ...
                                        <div className="grow-0 shrink-0 basis-auto w-full md:w-9/12 xl:w-7/12 px-3 mb-6 md:mb-0 mr-auto">
                                            ...
                                            <h4 className="text-left font-bold mb-3">
                                                Hello World Welcome To My Webside
                                            </h4></Link>
                                    ...
                                    <div className="flex flex-wrap mb-1 ">
                                        ...
                                        <div className="grow-0 shrink-0 basis-auto w-full md:w-9/12 xl:w-7/12 px-3 mb-6 md:mb-0 mr-auto">
                                            <Link href={route('readnews')} as="button"><h4 className="text-left font-bold mb-3">
                                                Hidup Sederhana
                                            </h4></Link>
                                            <div className="text-red-600 font-medium text-sm flex items-center justify-center md:justify-start">
                                                <svg
                                    ...
                                    <button className="btn btn-block mt-3"><Link href={route('shownews')} as="button">Lihat Selengkapnya</Link></button>
                                </section>
                            </div>
                    </div>
                    </aside>
